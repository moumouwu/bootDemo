...
-- ----------------------------
-- INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-L00KNEO1631756060336', 1631760518067, 15000);
...
-- ----------------------------
-- INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1631756060000, -1, 5, 'PAUSED', 'CRON', 1631756060000, 0, NULL, 2, '');
-- INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1631756070000, -1, 5, 'PAUSED', 'CRON', 1631756060000, 0, NULL, 2, '');
-- INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1631756060000, -1, 5, 'PAUSED', 'CRON', 1631756060000, 0, NULL, 2, '');
