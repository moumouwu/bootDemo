...
public class Test3 {
    ...
    public void queryHistoryTask() {
        List<HistoricTaskInstance> list = historyService.createHistoricTaskInstanceQuery() // 创建历史活动实例查询
                .processInstanceId("b0bf24b7-5284-11ec-a1bd-2cf05d0fe3e3") // 执行流程实例id
...
//                .active()
    ...
    public void departmentAudit() {
        String instanceId = "b0bf24b7-5284-11ec-a1bd-2cf05d0fe3e3"; // 任务ID
...
//        taskService.setAssignee(task1.getId(), "lisibanli");
    ...
    @org.junit.Test
    public void start() {
        String instanceKey = "myProcess_2";
        logger.info("开启请假流程...");
        Map<String, Object> map = new HashMap<String, Object>();
